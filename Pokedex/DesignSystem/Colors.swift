...
extension UIColor {
    ...
    struct TypeColor {
        ...
        static let electric = UIColor(named: "type-electric")
    ...
    struct BackgroundTypeColor {
        ...
        static let electric = UIColor(named: "background-type-electric")
        ...
        static func switchBackgroundTypeColor(type: TypeClass?) -> UIColor {
            ...
            case "electric": return UIColor.BackgroundTypeColor.electric ?? UIColor()
